...
<qgis version="2.14.0-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{25e09f2b-d83c-4589-ad90-02770eb1d441}">
      <rule scalemaxdenom="25000" key="{bf91a1b2-7367-4c25-ae16-8afa7ec991e8}" scalemindenom="1" label="1:25000">
        <rule filter="&quot;TYPE&quot; = 'motorway' OR &quot;TYPE&quot; = 'highway' or &quot;TYPE&quot; = 'trunk'" key="{357d84b0-e513-4e58-8cb6-35825a932aa0}" symbol="0" label="Motorway or highway"/>
        <rule filter="&quot;TYPE&quot; = 'motorway_link'" key="{1ee01a8b-e13d-4913-8a1a-85348d239672}" symbol="1" label="Motorway Link"/>
        <rule filter="&quot;TYPE&quot; = 'primary'" key="{75ccd3a9-e3d3-4e14-8320-f8ce5dced318}" symbol="2" label="Primary road"/>
        <rule filter="&quot;TYPE&quot; = 'primary_link'" key="{78bd422c-f2d1-4898-94a4-4bb52f9f262f}" symbol="3" label="Primary link"/>
        <rule filter="&quot;TYPE&quot; = 'tertiary'" key="{7efb71c6-a6a9-43d4-a4d4-efee89943561}" symbol="4" label="Tertiary"/>
        <rule filter="&quot;TYPE&quot; = 'tertiary_link'" key="{3ab6d27b-8a4b-4d97-a7dd-c93537218ab4}" symbol="5" label="Tertiary link"/>
        <rule filter="&quot;TYPE&quot; = 'secondary'" key="{ffdc36ef-460a-4660-b6fa-f3430ac11015}" symbol="6" label="Secondary"/>
        <rule filter="&quot;TYPE&quot; = 'secondary_link'" key="{043d02ce-d5c3-4fb7-8345-c2a3e1fa4492}" symbol="7" label="Secondary link"/>
        <rule filter="&quot;TYPE&quot; = 'living_street'  OR &quot;TYPE&quot; = 'residential' OR &quot;TYPE&quot; = 'yes' OR &quot;TYPE&quot; = 'road' OR &quot;TYPE&quot; = 'unclassified' OR &quot;TYPE&quot; = 'service' OR &quot;TYPE&quot; = ''" key="{f4d5542c-e581-436a-a8a2-1caeb462c0c6}" symbol="8" label="Road, residential, living street, etc."/>
        <rule filter="&quot;TYPE&quot; = 'track'" key="{fc607f30-087b-40f2-8494-d3482dc246e8}" symbol="9" label="Track"/>
        <rule filter="&quot;TYPE&quot; = 'cycleway' OR &quot;TYPE&quot; = 'footpath' OR &quot;TYPE&quot; = 'pedestrian' OR &quot;TYPE&quot; = 'footway' OR &quot;TYPE&quot; = 'path'" key="{8dc34b12-6f7e-4484-9139-7638072deb5b}" symbol="10" label="Cycleway, footpath etc."/>
      </rule>
      <rule scalemaxdenom="50000" key="{43a193de-6cfd-4644-80f5-237e5a019ff3}" symbol="11" scalemindenom="25001" label="25k to 50k"/>
      <rule scalemaxdenom="10000000" key="{4970416a-6151-4117-b810-e79bcbf74b80}" symbol="12" scalemindenom="50001" label="50k +"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        ...
        <layer pass="13" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="222,217,144,255"/>
          <prop k="line_style" v="solid"/>
