...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <displayfield>Name1</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="Name1"/>
    <edittype labelontop="0" editable="1" name="Name2"/>
    <edittype labelontop="0" editable="1" name="Note"/>
    <edittype labelontop="0" editable="1" name="ScaleRank"/>
    <edittype labelontop="0" editable="1" name="Delta"/>
  </edittypes>
  <editform></editform>
